...
function Collection() {
  return (
  <section className='py-8 px-4 lg:px-0.5 '>
      <div className='container mx-auto flex flex-col md:flex-row flex-wrap gap-6'>
        <div className='relative flex-1'>
        <img className='h-[500px] object-cover w-full' src={men_img} alt="" srcset="" />
        ...
        <div className='relative flex-1'>
          <img className='h-[500px] object-cover w-full' src={women_img} alt="" srcset="" />
